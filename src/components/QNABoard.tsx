  ...
  return (
    <div className="max-w-5xl">
      ...
      >
        ...
        <div className="col-span-7 col-start-2 flex items-center text-left">
          {item.boardSecret === "LOCK" ? (
            ...
            <div className="flex w-full items-center">
              ...
              />
              <button onClick={boardEdit} className="ml-4 bg-yellow-100 p-2">
                수정완료
              </button>
            </div>
          ) : (
            <div className="whitespace-pre-line break-all">{item.content}</div>
          )}
