...
export default function MyInquiries(): ReactElement {
  ...
  return (
    <div className="max-w-5xl">
      ...
      <div className="grid grid-cols-8 border-b border-t border-black py-4 text-center">
      ...
      {sampleMyInquiries.map((inquiry, index) => (
        ...
        >
          <div className="grid grid-cols-8 items-center border-b border-gray-400 py-2">
            <img
            ...
            <div className="col-span-5 whitespace-pre-line break-all">
              {getTitle(inquiry.title, index === selectedId)}
            </div>
